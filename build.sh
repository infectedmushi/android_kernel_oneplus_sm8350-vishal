...
TARGET_ARCH=arm64;
TARGET_CC=/mnt/Hawai/toolchains/clang-18-r510928/bin/clang;
TRAGET_CLANG_TRIPLE=aarch64-linux-gnu-;
TARGET_CROSS_COMPILE=/mnt/Hawai/toolchains/gcc-linaro-12.3.1-2023.06-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-;
TARGET_CROSS_COMPILE_ARM32=/mnt/Hawai/toolchains/gcc-linaro-12.3.1-2023.06-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf-;
THREAD=32;
TARGET_OUT=out;
...
cd out/ak3
zip -r9 deepongi-aospa-b6-ksu-v6-$(/bin/date -u '+%Y%m%d-%H%M').zip .
